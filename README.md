...
Visual entry point detailing platform features for state administrators.
![Splash Landing Page](assets/Screenshot%202026-07-26%20183909.png)

### 2. Officer Authentication and Sign In
Secure login panel with credential presets for rapid state testing.
![Officer Authentication Page](assets/Screenshot%202026-07-26%20183943.png)

### 3. Command Hub Dashboard
Live dashboard containing analytics feeds, district distributions, and case registration triggers.
![Command Hub Dashboard](assets/Screenshot%202026-07-26%20183955.png)

### 4. Investigator AI Copilot
Language processing portal accepting queries in English/Kannada to query the database.
![Investigator AI Copilot](assets/Screenshot%202026-07-26%20184013.png)

### 5. GIS Spatiotemporal Crime Mapper
Leaflet-rendered mapping interface showing coordinates, crime classifications, and date range filters.
![GIS Spatiotemporal Crime Mapper](assets/Screenshot%202026-07-26%20184024.png)

### 6. Syndicate Link (3D Relationship Graph)
